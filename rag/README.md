...
> Bizi의 핵심 AI 서비스입니다. LangGraph 기반 5단계 파이프라인(분류 > 분해 > 검색 > 생성 > 평가)으로 3개 도메인(창업/지원, 재무/세무, 인사/노무) 전문 상담을 제공합니다.
...
| 인사/노무 | 근로, 채용, 법률 | `hr_labor_db/` | ~8,200 |
| (공통) | 법령, 법령해석 | `law_common_db/` | ~187,800 |
