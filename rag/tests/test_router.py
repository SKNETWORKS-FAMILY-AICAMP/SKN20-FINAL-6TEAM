...
class TestRagasEvaluationInEvaluateNode:
    ...
    async def test_ragas_metrics_none_when_disabled(self):
        """enable_ragas_evaluation=False이면 ragas_metrics는 None이어야 한다."""
