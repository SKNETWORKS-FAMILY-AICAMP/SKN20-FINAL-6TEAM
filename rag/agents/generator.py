...
class ResponseGeneratorAgent:
    ...
    def generate(
        ...
        """검색 결과 기반으로 답변을 생성합니다 (동기).

        단일 도메인이면 도메인 프롬프트, 복수 도메인이면 통합 프롬프트를 사용합니다.
        ...
        logger.info("[생성기] 완료: %d자 (%.3fs)", len(content), elapsed)
