...
2. **주제 전환 감지 (최우선)**: 현재 질문의 핵심 주제/키워드가 이전 대화와 다르면, 반드시 원본 질문을 그대로 반환하세요. 예: 이전이 "세금/부가세"이고 현재가 "계약서/법률"이면 완전히 다른 주제입니다
...
→ {{"rewritten": "계약서 작성할 때 주의할 법적 사항은?", "is_rewritten": false}}
