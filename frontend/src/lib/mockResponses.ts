...
/** RAG 서비스 비활성 시 사용되는 Mock 응답 생성기 */
...
function generateLegalResponse(_question: string): string {
...
function generateFundingResponse(_question: string): string {
...
function generateMarketingResponse(_question: string): string {
